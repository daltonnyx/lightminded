...
class Category extends Model
{
     ...
     */
    public $table = 'jiri_jkshop_categories';
    ...
    public $hasMany = [
        'sales' => [
            'Jiri\JKShop\Models\CategoryUserSale',
            'delete' => true,
        ]
    ];
    public $belongsTo = [
...
//
    ...
    public static function resolveMenuItem($item, $url, $theme)
    {
        ...
        // --------------------------------------------------------------------
        // All shows
        $categories = \Jiri\JKShop\Models\Category::where("active",1)->where("show_in_menu",1)->where("nest_depth",0)->get();
