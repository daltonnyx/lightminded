...
class Coupon extends Model
{
     ...
     */
    public $table = 'jiri_jkshop_coupons';
    ...
    public $rules = [
        'value' => 'required',
        'code'=> 'unique:jiri_jkshop_coupons'
    ];    
    ...
    public $belongsToMany = [
        'categories' => [
            ...
            'table'    => 'jiri_jkshop_coupons_categories',
            'key'      => 'coupon_id',
            'otherKey' => 'category_id'
        ],
        'products' => [
            'Jiri\JKShop\Models\Product',
            'table'    => 'jiri_jkshop_coupons_products',
            'key'      => 'coupon_id',
            'otherKey' => 'product_id'
        ],
        'users' => [
            'RainLab\User\Models\User',
            'table'    => 'jiri_jkshop_coupons_users',
            'key'      => 'coupon_id',
            'otherKey' => 'user_id'
        ],        
    ];
