<?php
    ...
    // Paypal
    // ------------------------------------------------------------------------------------------------------
    Route::post('/jiri/jkshop/paypal-response', function () {
        // save IN to events
    ...
    function paypallValidateIPN() {
        ...
        curl_setopt($ch, CURLOPT_SSLVERSION, 1); // -JK- SSL error
        if (DEBUG == true) {
