...
class CreateSampleData extends Migration
{
    ...
    public function up()
    {
        // Order statuses
        DB::statement("
            INSERT INTO `jiri_jkshop_order_statuses` (`id`, `created_at`, `updated_at`, `title`, `color`, `active`, `send_email_to_customer`, `attach_invoice_pdf_to_email`, `mail_template_id`) VALUES
    ...
    {
        DB::statement("DELETE FROM system_settings where item = 'jiri_jkshop_settings'");
        //Schema::dropIfExists('jiri_jkshop_brands');
    }
