...
class CreatePaymentGatewaysTable extends Migration
{
    public function up()
    {
        Schema::create('jiri_jkshop_payment_gateways', function(Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
            $table->timestamps();
            ...
            $table->foreign('order_status_before_id')->references('id')->on('jiri_jkshop_order_statuses')->onDelete('set null');
            
            // Order status - after payment
            $table->integer('order_status_after_id')->unsigned()->nullable();
            $table->foreign('order_status_after_id')->references('id')->on('jiri_jkshop_order_statuses')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('jiri_jkshop_payment_gateways');
    }
}
